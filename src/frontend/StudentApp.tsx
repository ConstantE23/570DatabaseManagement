...
export default function StudentApp({ onBackToPortal }: StudentAppProps) {
  ...
  const fetchStudentData = async (user_id: number) => {
    ...
    try {
      ...
      const enrollRes = await fetch(
        `${API_URL}/enrollments?user_id=${user_id}`
      );
      if (enrollRes.ok) {
  ...
  const handleAssignContract = async (e: React.FormEvent) => {
    ...
    if (housing?.status === "Active") {
      alert(
        "You already have an active housing contract. Housing registration is not open at this time. Please contact the Housing Office if you have a concern."
      );
      ...
      >
        ...
        <nav className="flex-1 px-4 py-4 space-y-1">
          <button
            ...
            style={{
              backgroundColor:
                activeTab === "overview" ? COLORS.mutedBlue : "transparent",
          ...
          <button
            ...
            style={{
              backgroundColor:
                activeTab === "tickets" ? COLORS.mutedBlue : "transparent",
          ...
          <button
            ...
            style={{
              backgroundColor:
                activeTab === "enrollment" ? COLORS.mutedBlue : "transparent",
              color:
                activeTab === "enrollment" ? COLORS.cream : COLORS.steelBlue,
            }}
          >
            <BookOpen size={18} />
          ...
          <button
            ...
            style={{
              backgroundColor:
                activeTab === "housing" ? COLORS.mutedBlue : "transparent",
        ...
        >
          <div className="flex items-center gap-3 mb-3 px-1">
            ...
            <div className="min-w-0">
              ...
              <p className="text-xs" style={{ color: COLORS.steelBlue }}>
                Student
              </p>
            </div>
          </div>
            ...
            <AnimatePresence mode="wait">
              ...
              {activeTab === "overview" && (
                ...
                >
                  ...
                  >
                    Welcome back, {currentUser?.first_name}. Here is your
                    ...
                    <div className="bg-white rounded-2xl shadow-sm border border-black/5 p-6">
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div
                          ...
                          style={{ backgroundColor: COLORS.skyBlue + "66" }}
                        >
                          <p
                  ...
                  {housing?.status === "Pending" && (
                    ...
                    >
                      ...
                      <p className="text-xs mt-1" style={{ color: "#a16207" }}>
                        Your housing request is being reviewed by the Housing
                        Office.
                      </p>
                    </div>
                  )}
              ...
              <form onSubmit={handleAssignContract} className="space-y-5">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="Double" className="bg-slate-800">
                      Double
                    </option>
                    <option value="Suite" className="bg-slate-800">
                      Suite
                    </option>
                  </select>
                </div>
